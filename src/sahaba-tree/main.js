...
import { render, resetElements, clearHighlight } from "./render.js";
...
document.getElementById("reset").onclick = () => {
  clearHighlight(); clearOpened(); closeCard(); render(); fit({ readable: true });
  say(tr("showAll", "Showing all"));
};

document.getElementById("lang").onclick = () => {
  setLang(isAr() ? "en" : "ar");
  clearHighlight(); closeCard(); resetElements();
  applyLangStrings(); buildTimeline();
